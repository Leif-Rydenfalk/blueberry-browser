...
import { buildSimpleTools, type ToolResult } from "./tools/simpleTools";
...
// ToolResult is imported from ./tools/simpleTools — single source of truth.
...
export class McpAgentRunner {
  ...
  private buildTools(): Record<string, any> {
    const runTool = this.runTool.bind(this);
    return {
      ...buildSimpleTools(runTool),
