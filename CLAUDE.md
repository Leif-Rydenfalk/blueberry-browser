...
read TESTING.md only when you need to run tests - but very useful to read then. Describes how tests are supposed to be run.

Dont take credit for commits - give all credits to me Leif Rydenfalk - ledamecrydenfalk@gmail.com. No claude co author. Always commit everything. 
