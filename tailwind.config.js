...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      borderRadius: { lg: "var(--radius)", md: "calc(var(--radius) - 0.1rem)", sm: "calc(var(--radius) - 0.4rem)" },
      fontSize: { "2xs": ["0.625rem", "0.75rem"] },
      ...
      keyframes: {
        "spring-scale": { "0%": { transform: "scale(0.95)" }, "50%": { transform: "scale(1.02)" }, "100%": { transform: "scale(1)" } },
